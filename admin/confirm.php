		...
		mysqli_query($conn, "UPDATE transaction SET order_stat = 'Confirmed' WHERE transaction_id = '$t_id'");
		...
		while ($row = mysqli_fetch_array($query2)) {
			...
			$query = mysqli_query($conn, "UPDATE stock SET qty = '$stck_out' WHERE product_id = '$pid'");
		}

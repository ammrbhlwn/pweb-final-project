		...
		<div class="content-dashboard">
			...
			<div class="table-container">
				<table class="table-content">
					<thead>
						<tr>
							<th style="font-size:1.2rem">Product Image</th>
							<th style="font-size:1.2rem">Product Name</th>
							<th style="font-size:1.2rem">Product Price</th>
							<th style="font-size:1.2rem">Product Sizes</th>
							<th style="font-size:1.2rem">No. of Stock</th>
					...
					<tbody>
						...
						?>
							<tr class="del<?php echo $id ?>">
								<td style="width: 142px; text-align: center; align-self:center"><img class="img-polaroid" src="../photo/<?php echo $fetch['product_image'] ?>" height="70px" width="80px"></td>
								<td style="width: 138px; text-align: center; align-self:center"><?php echo $fetch['product_name'] ?></td>
								<td style="width: 128px; text-align: center; align-self:center"><?php echo $fetch['product_price'] ?></td>
								<td style=" width: 128px; text-align: center; align-self:center"><?php echo $fetch['product_size'] ?></td>
								...
								<td style="width: 112px; text-align: center; align-self:center"><?php echo $fetch1['qty'] ?></td>
								<td class="btn-action">
									<?php
									echo "<a href='stockin.php?id=" . $id . "' class='btn-in' rel='facebox'><i class='icon-plus-sign icon-white'></i> Stock In</a> ";
									echo "<a href='stockout.php?id=" . $id . "' class='btn-out' rel='facebox'><i class='icon-minus-sign icon-white'></i> Stock Out</a>";
									?>
								</td>
							</tr>
						<?php
